...
KEditScheduledDepositDlg::KEditScheduledDepositDlg(const QCString& accountId, QWidget *parent, const char *name)
...
void KEditScheduledDepositDlg::okClicked()
{
  ...
  if (method == i18n("Direct Deposit"))
    m_schedule.setPaymentType(MyMoneySchedule::STYPE_DIRECTDEPOSIT);
  else if (method == i18n("Manual Deposit"))
