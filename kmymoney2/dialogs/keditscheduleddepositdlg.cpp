...
KEditScheduledDepositDlg::KEditScheduledDepositDlg(const QCString& accountId, const MyMoneySchedule& schedule, QWidget *parent, const char *name)
...
void KEditScheduledDepositDlg::slotWillEndToggled(bool on)
{
...
void KEditScheduledDepositDlg::reloadWidgets(void)
{
  QString category;
  try {
    MyMoneySplit s;
...
MyMoneySchedule KEditScheduledDepositDlg::schedule(void)
{
  return m_schedule;
}

void KEditScheduledDepositDlg::okClicked()
{
...
void KEditScheduledDepositDlg::loadWidgetsFromSchedule(void)
{
  try
  {
