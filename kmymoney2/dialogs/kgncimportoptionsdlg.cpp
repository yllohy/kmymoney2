...
void KGncImportOptionsDlg::slotHelp(void)
{
  ...
  "<h2>Investment Options</h2>"
    ...
    "the share balance, the investment account a money balance</p>"
    "<p>GnuCash does not do this, so we cannot automate this function. If you have investments, "
    "you must select one of the following options.</p>"
