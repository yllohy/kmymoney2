...
//******************************* convertPrice ************************************************
void MyMoneyStorageGNC::convertPrice (const GncPrice *gpr) {
  Q_CHECK_PTR (gpr);
...
//*********************************convertAccount ****************************************
void MyMoneyStorageGNC::convertAccount (const GncAccount* gac) {
  Q_CHECK_PTR (gac);
  TRY
...
//********************************************** convertTransaction *****************************
void MyMoneyStorageGNC::convertTransaction (const GncTransaction *gtx) {
  Q_CHECK_PTR (gtx);
...
//******************************************convertSplit********************************
void MyMoneyStorageGNC::convertSplit (const GncSplit *gsp) {
  Q_CHECK_PTR (gsp);
  MyMoneySplit split;
...
MyMoneyTransaction MyMoneyStorageGNC::convertTemplateTransaction (const QString schedName, const GncTransaction *gtx) {
...
void MyMoneyStorageGNC::convertTemplateSplit (const QString schedName, const GncTemplateSplit *gsp) {
  Q_CHECK_PTR (gsp);
  // convertTemplateSplit
  MyMoneySplit split;
  MyMoneyAccount splitAccount;
...
//********************************* convertSchedule  ********************************************************
void MyMoneyStorageGNC::convertSchedule (const GncSchedule *gsc) {
  TRY
  Q_CHECK_PTR (gsc);
  MyMoneySchedule sc;
  MyMoneyTransaction tx;
...
//********************************* convertFreqSpec  ********************************************************
void MyMoneyStorageGNC::convertFreqSpec (const GncFreqSpec *) {
...
//**********************************************************************************************************
//************************************* terminate **********************************************************
void MyMoneyStorageGNC::terminate () {
  TRY
...
//************************************ buildReportSection************************************
const QString MyMoneyStorageGNC::buildReportSection (const QString source) {
  TRY
  QString s = "";
  bool more = false;
  if (source == "MN") {
...
//************************ writeReportToFile*********************************
bool MyMoneyStorageGNC::writeReportToFile (const QValueList<QString> sectionsToReport) {
  TRY
  unsigned int i;
...
const QString MyMoneyStorageGNC::createPayee (const QString gncDescription) {
  MyMoneyPayee payee;
  try {
...
//************************************** createOrphanAccount *******************************
const QCString MyMoneyStorageGNC::createOrphanAccount (const QString gncName) {
  MyMoneyAccount acc;
...
//****************************** incrDate *********************************************
QDate MyMoneyStorageGNC::incrDate (QDate lastDate, unsigned char interval, unsigned int intervalCount) {
  TRY
  switch (interval) {
  case 'd':
...
void MyMoneyStorageGNC::checkInvestmentOption (QString stockId) {
...
void MyMoneyStorageGNC::postMessage (const QString source, const unsigned int code, ...) {
  TRY
  unsigned int i;
  ...
  if (gncdebug) qDebug
    ("MyMoneyStorageGNC::postMessage: Message %s, code %d, requires %d arguments of type char *, else may segfault",
