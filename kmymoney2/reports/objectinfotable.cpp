...
QStringList ObjectInfoTable::TableRow::m_sortCriteria;
...
public:
  ...
  GroupIterator(void) {}
  void update(const ObjectInfoTable::TableRow& _row)
  {
...
bool ObjectInfoTable::TableRow::operator<( const TableRow& _compare ) const
{
  bool result = false;
...
ObjectInfoTable::ObjectInfoTable(const MyMoneyReport& _report): m_config(_report)
{
...
void ObjectInfoTable::render( QString& result, QString& csv ) const
{
...
QString ObjectInfoTable::renderHTML( void ) const
{
  QString html, csv;
  render( html,csv );
  return html;
...
QString ObjectInfoTable::renderCSV( void ) const
{
  QString html, csv;
  render( html,csv );
  return csv;
...
void ObjectInfoTable::dump( const QString& file, const QString& context ) const
{
  QFile g( file );
  g.open( IO_WriteOnly );
